...
@protocol SBUIBiometricEventObserver, SBUIPasscodeLockViewDelegate_Internal, SBFLegibilitySettingsProvider, SBFLegibilitySettingsProviderDelegate, SBUIBiometricEventObserver, SBUIPasscodeLockView_Internal, SBUIPasscodeLockView;
...
@property (copy,readonly) NSString * debugDescription;                                                   //@synthesize delegate=_delegate - In the implementation block
...
-(void)_setEntryField:(SBUIPasscodeEntryField *)arg1 ;
